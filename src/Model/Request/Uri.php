...
class Uri implements UriInterface
{
    ...
    public function __construct(string $uri)
    {
        ...
        $this->scheme = (string)parse_url($uri, PHP_URL_SCHEME);
        $this->host = (string)parse_url($uri, PHP_URL_HOST);
        $this->port = (int)parse_url($uri, PHP_URL_PORT);
        $this->user = (string)parse_url($uri, PHP_URL_USER);
        $this->password = (string)parse_url($uri, PHP_URL_PASS);
    ...
    public function __toString(): string
    {
        ...
        $uri .= $this->getPath() !== '' ? '/' . ltrim($this->getPath(), '/') : '';
